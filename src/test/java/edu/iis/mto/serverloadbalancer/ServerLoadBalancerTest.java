...
public class ServerLoadBalancerTest {
	...
	public void vmsShouldBeBalancedOnLessLoadedServerFirst() {
		...
		assertThat("more loaded server should contain the vm", lessLoadedServer.contains(theVm));
		assertThat("less loaded server should not contain the second vm", !moreLoadedServer.contains(theVm));
	}
